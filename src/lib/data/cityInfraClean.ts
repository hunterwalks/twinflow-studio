...
/**
 * 合成「城市基础设施（干净）」数据集（v0.7.0 新增，v0.8.0 扩展观测表）
 *
 * 纯合成数据，不含任何真实客户、项目、个人或敏感信息。
 * 结构完整：park → building → floor → zone 层级正确、引用闭合、
 * 每个资产都有测点引用、量纲与单位一致；观测表引用全部已存在的
 * 测点（SE-101~SE-108）、时间戳合法（ISO 8601）、数值可解析、
 * 同测点时间戳不重复。用于验证「干净数据（含四表齐全）不应产生规则误报」。
 */
export const cityInfraClean: RuleDataset = {
  observations: [
    { id: "OB-101", sensorId: "SE-101", timestamp: "2026-08-10T08:00:00Z", value: "7.2", quantity: "温度", unit: "°C", quality: "good" },
    { id: "OB-102", sensorId: "SE-102", timestamp: "2026-08-10T08:05:00Z", value: "320", quantity: "压力", unit: "kPa", quality: "good" },
    { id: "OB-103", sensorId: "SE-103", timestamp: "2026-08-10T08:10:00Z", value: "12.4", quantity: "功率", unit: "kW", quality: "good" },
    { id: "OB-104", sensorId: "SE-104", timestamp: "2026-08-10T08:15:00Z", value: "0.62", quantity: "功率", unit: "kW", quality: "good" },
    { id: "OB-105", sensorId: "SE-105", timestamp: "2026-08-10T08:20:00Z", value: "45.1", quantity: "流量", unit: "m³/h", quality: "good" },
    { id: "OB-106", sensorId: "SE-106", timestamp: "2026-08-10T08:25:00Z", value: "88.6", quantity: "功率", unit: "kW", quality: "good" },
    { id: "OB-107", sensorId: "SE-107", timestamp: "2026-08-10T08:30:00Z", value: "10.2", quantity: "电压", unit: "kV", quality: "good" },
    { id: "OB-108", sensorId: "SE-108", timestamp: "2026-08-10T08:35:00Z", value: "1.8", quantity: "振动", unit: "mm/s", quality: "good" },
  ],
  spaces: [
    { id: "SP-101", name: "滨江智慧城区", type: "park", parentId: "", description: "城市级根空间对象" },
