...
**当前版本：v1.5.0（可用性硬化收官：全部功能页的辅助性说明文字收敛至「帮助」页统一承载，并完成关系图 / 对比 / 模型 / 帮助 / 项目 / Demo 六页在 v1.4 设计系统上的整体焕新；继承 v1.4.0 深色左栏 + 极简顶栏外壳、统一设计令牌与 PageHeader / Card / Button / InfoStrip / Stepper 组件库，以及 24 条确定性规则与多表批量导入等能力）**
