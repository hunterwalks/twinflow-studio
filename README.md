...
**当前版本：v1.3.1（导航栏观感补丁：首页独立常驻 + 数据建模 / 质量治理 / 高级工具 三段分组、实色当前页高亮、分段容器视觉强化；并继承 v1.3.0 的面包屑、状态感知首页、统一空/错态、全局 toast、CONTRIBUTING.md GPT 政策，以及 v1.2.0 的关系图专项与多表批量导入、24 条确定性规则等）**
